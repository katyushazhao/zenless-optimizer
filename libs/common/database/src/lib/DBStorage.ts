export const dbVersionKeys = ['db_ver', 'sro_db_ver', 'zzzo_db_ver'] as const
export type DbVersionKey = (typeof dbVersionKeys)[number]

export const dbIndexKeys = ['dbIndex', 'sro_dbIndex', 'zzzo_dbIndex'] as const
export type DbIndexKey = (typeof dbIndexKeys)[number]

export type StorageType = 'go' | 'sro' | 'zzzo'
